    ...
    return (
        <>
            <nav className="bg-emerald-800 w-full border-t border-gray-200 shadow-lg z-50">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-start py-8 px-6 md:px-20 lg:px-40 gap-8 md:gap-0">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-start gap-8 md:gap-20 w-full md:w-auto">
                        ...
                        <div className="flex flex-col gap-2 items-start">
                            ...
                            <div className="mb-4"></div> {/* Added space after Volunteering */}
                            <Link
                    ...
                    <div className="flex flex-col gap-6 w-full lg:w-auto lg:ml-6">
                        {/* Social Icons */}
                        <div className="flex flex-row gap-4 items-center mb-6 lg:mb-8">
                        ...
                        {/* Contact Details */}
                        <div className="flex flex-col gap-2 items-start text-white text-sm max-w-xs">
                            ...
                            <div className="flex items-start gap-2 max-w-xs">
                                ...
                                <div className="text-justify">
                                    ...
                                    <p>Paramount Avenue, 63/1, 3rd floor</p>
                                    <p>Mosque road cross</p>
                ...
                <div className="w-full mt-6 pt-4 pb-20 md:pb-4">
                    <p className="text-center text-white text-sm md:text-base block">
